...
class AppStyle {
  ...
  static TextStyle txtPoppinsMedium12Gray9008b = TextStyle(
    color: ColorConstant.gray9008b,
    fontSize: getFontSize(
      12,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsRegular18 = TextStyle(
    color: ColorConstant.gray9007e,
    fontSize: getFontSize(
      18,
    ),
  ...
  static TextStyle txtPoppinsMedium12Deeporange500a2 = TextStyle(
    color: ColorConstant.deepOrange500A2,
    fontSize: getFontSize(
      12,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsBold34 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium16DeeppurpleA400 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium12Gray90090 = TextStyle(
    color: ColorConstant.gray90090,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsMedium14Gray90090 = TextStyle(
    color: ColorConstant.gray90090,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPoppinsRegular12Gray900a2 = TextStyle(
    color: ColorConstant.gray900A2,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsMedium16Lightblue400 = TextStyle(
